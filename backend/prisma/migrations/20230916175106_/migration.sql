...
-- AddForeignKey
ALTER TABLE `ItemProposal` ADD CONSTRAINT `ItemProposal_proposalId_fkey` FOREIGN KEY (`proposalId`) REFERENCES `Proposal`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
