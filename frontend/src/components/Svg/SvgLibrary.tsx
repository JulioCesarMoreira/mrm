...
export { default as service_item } from '../../assets/svgs/service_item.svg';
export { default as services } from '../../assets/svgs/services.svg';
export { default as well } from '../../assets/svgs/well.svg';
